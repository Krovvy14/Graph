...
def main():
    ...
    if args.write_file:
        ...
        graph_builder.build_graph(pcap_parser.complete_view(pcap_file), '%s_red_team' % os.path.basename(pcap_file[:-5]))
        graph_builder.build_graph(pcap_parser.complete_view(pcap_file), '%s_scorebot' % os.path.basename(pcap_file[:-5]))
        ...
        #"bites". This functon reads each of the smaller pcap file_transfer
        #and builds three graphs from them.
